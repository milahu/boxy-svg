...
const c = ["text", "textPath", "tspan"];
const h = [...m, ...c, "foreignObject", "image"];
const u = [...m, ...c];
const f = ["solidcolor", "linearGradient", "radialGradient", "pattern"];
...
const b = ["feFuncA", "feFuncB", "feFuncG", "feFuncR"];
const y = ["feDistantLight", "fePointLight", "feSpotLight"];
const k = ["animate", "animateMotion", "animateTransform", "set"];
const w = [
  ...h,
  ...f,
  ...d,
...
const N = {
  ...
  "bx-title": ["#text"],
  circle: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  clipPath: [...k, ...d, ...m, "text", "use", "script", "style"],
  defs: [
    ...k,
    ...d,
    ...f,
  ...
  image: [...k, ...d, "clipPath", "mask", "script", "style"],
  line: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  linearGradient: [
    ...d,
    "animate",
    "animateTransform",
  ...
  mpath: [...d, "script"],
  path: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  pattern: [
    ...d,
    ...f,
    ...m,
  ...
  polygon: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  polyline: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  radialGradient: [
    ...d,
    "animate",
    "animateTransform",
  ...
  rect: [...k, ...d, ...f, "clipPath", "marker", "mask", "script", "style"],
  script: ["#text"],
  set: [...d, "script"],
  ...
  use: [...k, ...d, ...f, "clipPath", "mask", "script", "style"],
  view: [
    ...d,
    "animate",
    "animateMotion",
...
const C = U.map((a8) => a8.presentationAttributeName).filter((a8) => a8);
let F = (a8, a9 = 0) => {
  let aa = Math.pow(10, a9);
  return Math.round((a8 + Number.EPSILON) * aa) / aa;
};
let T = (a8, a9, aa = Infinity, ab = null) => {
  if (ab !== null) {
    a8 = F(a8, ab);
  }
  if (a8 < a9) {
...
class D {
  ...
  static fromString(a8, a9 = false, aa = false) {
    ...
    }
    {
      ...
      let ah = A.fromString(a8.split(ac.currentToken.value)[1], a9);
      if (ah !== null) {
...
class B {
  ...
  static fromString(a8, a9 = false, aa = false) {
    ...
    if (ac.currentToken.tokenType === "DIMENSION") {
      ...
      }
      {
        ...
        let ah = A.fromString(a8.split(ac.currentToken.value)[1], a9);
        if (ah !== null) {
          return new B(ad, af, ag ? -ah.seconds : ah.seconds);
        }
      }
    }
  }
  ...
  clone() {
    return new B(this.#i, this.#l, this.#t);
  }
  compare(a8) {
    return (
      a8.type === this.type &&
  ...
  getLocalFontsMetadata(a8 = false) {
    return new Promise(async (a9, aa) => {
      if (this.status === "no-api") {
        ...
        if (this.#u.length < 10 || a8) {
          try {
            this.#u = await window.queryLocalFonts();
          } catch (ab) {
            return aa({
              message: ab.message,
              name: ab.name,
...
let H = (a8, a9 = 6) => {
  ...
  for (let ac of ab) {
    ac.values = ac.values.map((ad) => F(ad, a9));
  }
  aa.setPathData(ab);
...
class ee {
  ...
  constructor(a8) {
    ...
    this.#f.setAttribute("style", Z);
    this.#f.setAttribute("class", "offscreen-container");
    this.#f.attachShadow({
      mode: "open",
    });
    this.#f.shadowRoot.append(a8);
    document.body.append(this.#f);
  }
  destroy() {
    if (this.#d.parentNode === this.#f.shadowRoot) {
      this.#d.remove();
    }
    this.#f.remove();
    this.#f = null;
...
let ce = (a8) => he(a8.getAttribute("begin"));
let he = (a8, a9 = false) => {
  let aa = [];
  if (a8 !== null) {
    let ab = a8
...
class ge extends HTMLElement {
  static #g = I` <template> <main id="main" part="main"></main> <footer id="footer" part="footer"></footer> </template>
  `;
  static #x = R`
    :host {
      display: flex;
  ...
  constructor() {
    ...
    this.#b = this.attachShadow({
      mode: "closed",
    });
    this.#b.adoptedStyleSheets = [
      a2.themeStyleSheet,
      ge.#x,
      this.constructor._shadowStyleSheet,
    ];
    this.#b.append(document.importNode(ge.#g.content, true));
    if (a8) {
      this.#b
        .querySelector("#main")
    ...
    for (let aa of this.#b.querySelectorAll("[id]")) {
      this["#" + aa.id] = aa;
    }
...
let Se = "·*+=$@#";
class Ae extends ge {
  static t = I` <template> <section id="options-section"> <h3 id="options-heading"><x-message href="#options" autocapitalize></x-message></h3> <section id="grid-subsection"> <x-box> <x-box id="columns-box" vertical> <h4 id="columns-heading"><x-message href="#columns" autocapitalize></x-message></h4> <x-numberinput id="columns-input" min="1" step="1" condensed> <x-stepper></x-stepper> </x-numberinput> </x-box> <x-box id="rows-box" vertical> <h4 id="rows-heading"><x-message href="#rows" autocapitalize></x-message></h4> <x-numberinput id="rows-input" min="1" step="1" condensed> <x-stepper></x-stepper> </x-numberinput> </x-box> </x-box> </section> <section id="chars-subsection"> <h4 id="chars-heading"><x-message href="#characters" autocapitalize></x-message></h4> <x-box> <x-input id="chars-input"> <x-label>${Se}</x-label> </x-input> <x-button id="reverse-chars-button" condensed> <x-icon href="#reverse" size="small"></x-icon> <x-tooltip><x-message href="#reverse-order"></x-message></x-tooltip> </x-button> </x-box> </section> <section id="char-color-subsection"> <h4 id="char-color-heading"><x-message href="#character-color" autocapitalize></x-message></h4> <x-box id="char-color-box"> <x-select id="char-color-source-select"> <x-menu id="char-color-source-menu"> <x-menuitem value="sample"> <x-label><x-message href="#sample-from-image" autocapitalize></x-message></x-label> </x-menuitem> <x-menuitem value="custom" toggled> <x-label><x-message href="#color.custom" autocapitalize></x-message></x-label> </x-menuitem> </x-menu> </x-select> <x-colorselect id="char-custom-color-select" value="#ffffff" alpha></x-colorselect> </x-box> </section> <section id="char-background-color-subsection"> <h4 id="char-background-color-heading"> <x-message href="#character-background-color" autocapitalize></x-message> </h4> <x-box id="char-background-color-box"> <x-select id="char-background-color-source-select"> <x-menu id="char-background-color-source-menu"> <x-menuitem value="sample" toggled> <x-label><x-message href="#sample-from-image" autocapitalize></x-message></x-label> </x-menuitem> <x-menuitem value="custom"> <x-label><x-message href="#color.custom" autocapitalize></x-message></x-label> </x-menuitem> </x-menu> </x-select> <x-colorselect id="char-custom-background-color-select" value="#ffffff" alpha></x-colorselect> </x-box> </section> <section id="font-size-subsection"> <h4 id="font-size-heading"><x-message href="#font-size" autocapitalize></x-message></h4> <x-box id="font-size-box"> <x-slider id="font-size-slider" min="1" max="200" step="1"></x-slider> <x-numberinput id="font-size-input" min="1" max="200" step="1" suffix="%" condensed> <x-stepper></x-stepper> </x-numberinput> </x-box> </section> </section> <hr id="preview-section-hr"> <section id="preview-section"> <h3 id="preview-heading"><x-message href="#preview" autocapitalize></x-message></h3> <svg id="preview" part="preview" preserveAspectRatio="xMidYMid"></svg> </section> </template>
  `;
  static l = I` <template> <x-button id="generate-button" size="large"> <x-icon href="#generators-panel"></x-icon> <x-label><x-message href="#generators.asciify" autocapitalize></x-message></x-label> </x-button> </template>
  `;
  static _shadowStyleSheet = R`#grid-subsection{margin-top:14px}#grid-subsection h4{margin-top:0}#columns-box{flex:1;margin-right:4px}#columns-input{width:100%}#rows-box{flex:1;margin-left:4px}#rows-input{width:100%}#chars-subsection{margin-top:14px}#chars-input{flex:1;max-width:none;font-family:monospace}#reverse-chars-button{margin-left:8px}#char-color-subsection{margin-top:14px}#char-color-box{margin-top:4px}#char-color-source-select{flex:1}#char-custom-color-select{margin-left:6px}#char-background-color-subsection{margin-top:14px}#char-background-color-box{margin-top:4px}#char-background-color-source-select{flex:1}#char-custom-background-color-select{margin-left:6px}#font-size-subsection{display:flex;flex-flow:column;margin-top:14px}#font-size-subsection h4{margin-bottom:0}#font-size-slider{flex:1}#font-size-input{margin-left:10px;width:60px}#preview{height:160px}`;
  get options() {
    return {
      columns: this["#columns-input"].value,
      rows: this["#rows-input"].value,
      chars:
        this["#chars-input"].value.length > 0
          ? this["#chars-input"].value.split("")
          : Se,
      charColorSource: this["#char-color-source-select"].value,
      charCustomColor: this["#char-custom-color-select"].value,
      charBackgroundColorSource:
        this["#char-background-color-source-select"].value,
      charCustomBackgroundColor:
        this["#char-custom-background-color-select"].value,
      fontSize: this["#font-size-input"].value / 100,
      geometryPrecision: this.#y.board.geometryPrecision,
    };
  }
  #y;
  #k;
  ...
  constructor() {
    super();
    this["#columns-input"].addEventListener("changestart", () => {
      this.#v();
    });
    this["#rows-input"].addEventListener("changestart", () => {
      this.#N();
    });
    this["#chars-input"].addEventListener("input", () => {
      this.#U();
    });
    this["#chars-input"].addEventListener("change", () => {
      this.#C();
    });
    this["#reverse-chars-button"].addEventListener("click", () => {
      this.#F();
    });
    this["#char-color-source-select"].addEventListener("change", () => {
      this.#T();
    });
    this["#char-custom-color-select"].addEventListener("changeend", () => {
      this.#E();
    });
    this["#char-background-color-source-select"].addEventListener(
      "change",
      () => {
        this.#S();
      }
    );
    this["#char-custom-background-color-select"].addEventListener(
      "changeend",
      () => {
        this.#A();
      }
    );
    this["#font-size-box"].addEventListener("changestart", () => {
      this.#D();
    });
    this["#generate-button"].addEventListener("click", () => {
      this.#M();
    });
  }
  connectedCallback() {
    this.#y = de(this, "bx-editor");
    let a8 = a2.getConfig("bx-asciifygenerator:columns", 20);
    let a9 = a2.getConfig("bx-asciifygenerator:rows", 20);
    let aa = a2.getConfig("bx-asciifygenerator:chars", "");
    let ab = a2.getConfig("bx-asciifygenerator:charColorSource", "custom");
    let ac = a2.getConfig("bx-asciifygenerator:charCustomColor", "#ffffff");
    let ad = a2.getConfig(
      "bx-asciifygenerator:charBackgroundColorSource",
      "sample"
    );
    let af = a2.getConfig(
      "bx-asciifygenerator:charCustomBackgroundColor",
      "#000000"
    );
    let ag = a2.getConfig("bx-asciifygenerator:fontSize", 1);
    this["#columns-input"].value = a8;
    this["#rows-input"].value = a9;
    this["#chars-input"].value = aa;
    this["#char-color-source-select"].value = ab;
    this["#char-custom-color-select"].value = ac;
    this["#char-background-color-source-select"].value = ad;
    this["#char-custom-background-color-select"].value = af;
    this["#font-size-slider"].value = F(ag * 100, 2);
    this["#font-size-input"].value = F(ag * 100, 2);
    this.#P();
    this.#y.board.addEventListener(
  ...
  disconnectedCallback() {
    this.#y.board.removeEventListener("selectedelementschange", this.#k);
    this.#y.board.removeEventListener("workspacemutation", this.#w);
  }
  #v(a8) {
    let a9;
    let aa;
    let ab = this["#rows-input"].value / this["#columns-input"].value;
    this["#columns-input"].addEventListener(
      "change",
      (a9 = () => {
        this["#rows-input"].value = Math.ceil(
          this["#columns-input"].value * ab
        );
      })
    );
    this["#columns-input"].addEventListener(
      "changeend",
      (aa = () => {
        this["#columns-input"].removeEventListener("change", a9);
        this["#columns-input"].removeEventListener("changeend", aa);
        a2.setConfig(
          "bx-asciifygenerator:columns",
          this["#columns-input"].value
        );
        a2.setConfig("bx-asciifygenerator:rows", this["#rows-input"].value);
        this.#P();
      })
    );
  }
  #N(a8) {
    let a9;
    let aa;
    let ab = this["#columns-input"].value / this["#rows-input"].value;
    this["#rows-input"].addEventListener(
      "change",
      (a9 = () => {
        this["#columns-input"].value = Math.ceil(
          this["#rows-input"].value * ab
        );
      })
    );
    this["#rows-input"].addEventListener(
      "changeend",
      (aa = () => {
        this["#rows-input"].removeEventListener("change", a9);
        this["#rows-input"].removeEventListener("changeend", aa);
        a2.setConfig(
          "bx-asciifygenerator:columns",
          this["#columns-input"].value
        );
  ...
  #C() {
    a2.setConfig("bx-asciifygenerator:chars", this["#chars-input"].value);
  }
  #F() {
    let a8 = this["#chars-input"].value.split("").reverse().join("");
    this["#chars-input"].value = a8;
    a2.setConfig("bx-asciifygenerator:chars", a8);
    this.#P();
  }
  #T() {
    a2.setConfig(
      "bx-asciifygenerator:charColorSource",
      this["#char-color-source-select"].value
    );
    this.#P();
  }
  #E() {
    a2.setConfig(
      "bx-asciifygenerator:charCustomColor",
      this["#char-custom-color-select"].value
    );
    this.#P();
  }
  #S() {
  ...
  #D() {
    let a8;
    let a9;
    this["#font-size-box"].addEventListener(
      "change",
      (a8 = (aa) => {
        if (aa.target === this["#font-size-slider"]) {
          this["#font-size-input"].value = this["#font-size-slider"].value;
        } else if (aa.target === this["#font-size-input"]) {
          this["#font-size-slider"].value = this["#font-size-input"].value;
        }
      })
    );
    this["#font-size-box"].addEventListener(
      "changeend",
      (a9 = () => {
        this["#font-size-box"].removeEventListener("change", a8);
        this["#font-size-box"].removeEventListener("changeend", a9);
        a2.setConfig(
          "bx-asciifygenerator:fontSize",
          this["#font-size-slider"].value / 100
        );
        this.#P();
      })
    );
  ...
  async #M() {
    let a8 = this.#y.board;
    let a9 = null;
    let aa = this.#y.board.outermostSelectedObjectElements[0];
    if (aa.localName === "image") {
      a9 = await createImageBitmap(aa);
    } else {
      let ag = this.#y.board.extractArtworkWithSelectedElements();
      let ah = Ce(ag);
    ...
    let ac = await this.#z(a9, this.options);
    let ad = Ne(ac);
    ad.setAttribute("preserveAspectRatio", "none");
    a8.undoManager.checkpoint(["#generators.asciify"], "#generators-panel");
  ...
  async #P() {
    let a8 = null;
    if (this.#y.board.outermostSelectedObjectElements.length === 1) {
      let a9 = this.#y.board.outermostSelectedObjectElements[0];
      let aa = a9.getBoundingClientRect();
      if (aa.width >= 1 && aa.height >= 1) {
        if (a9.localName === "image") {
          a8 = await createImageBitmap(a9);
        } else {
          let ab = this.#y.board.extractArtworkWithSelectedElements();
          let ac = Ce(ab);
    ...
    this["#columns-heading"].disabled = a8 === null;
    this["#columns-input"].disabled = a8 === null;
    this["#rows-heading"].disabled = a8 === null;
    this["#rows-input"].disabled = a8 === null;
    if (a8) {
      let af = a8.height / a8.width;
      this["#rows-input"].value = Math.floor(this["#columns-input"].value * af);
    }
    if (a8 === null) {
      this["#chars-heading"].disabled = true;
      this["#chars-input"].disabled = true;
      this["#reverse-chars-button"].disabled = true;
    } else {
      this["#chars-heading"].disabled = false;
      this["#chars-input"].disabled = false;
      this["#reverse-chars-button"].disabled = false;
    }
    if (a8 === null) {
      this["#char-color-heading"].disabled = true;
      this["#char-color-source-select"].disabled = true;
      this["#char-custom-color-select"].disabled = true;
    } else {
      this["#char-color-heading"].disabled = false;
      this["#char-color-source-select"].disabled = false;
      this["#char-custom-color-select"].disabled =
        this["#char-color-source-select"].value !== "custom";
    }
    if (a8 === null) {
      this["#char-background-color-heading"].disabled = true;
      this["#char-background-color-source-select"].disabled = true;
      this["#char-custom-background-color-select"].disabled = true;
    } else {
      this["#char-background-color-heading"].disabled = false;
      this["#char-background-color-source-select"].disabled = false;
      this["#char-custom-background-color-select"].disabled =
        this["#char-background-color-source-select"].value !== "custom";
    }
    this["#font-size-heading"].disabled = a8 === null;
    this["#font-size-slider"].disabled = a8 === null;
    this["#font-size-input"].disabled = a8 === null;
    if (a8 === null) {
...
customElements.define("bx-asciifygenerator", Ae);
